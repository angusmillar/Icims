...
namespace Icims.MocekedIcimsEndpoint.Controllers
{
  ...
  public class MockController : ControllerBase
  {
    ...
    public IActionResult PostMerge([FromForm]Merge Data)
    {
      ...
      if (!TestValue("prior_ur", Data.prior_ur, "3008781", out Response)) return BadRequest(Response);
      if (!TestValue("prior_assigning_authority", Data.prior_assigning_authority, "3008781", out Response)) return BadRequest(Response);
